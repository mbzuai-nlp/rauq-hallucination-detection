...
def register_default_stat_calculators(
    ...
    if model_type == "Blackbox":
        ...
        _register(TokenEmbeddingsCalculator)
        _register(LookbackRatioCalculator)
        _register(AttentionFeaturesCalculator)
        ...
        _register(
            ...
            "default_SamplingGenerationCalculator",
            {"samples_n": samples_n},
        )
        ...
        _register(
            ...
            "default_AttentionForwardPassCalculator",
